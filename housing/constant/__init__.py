...
CONFIG_FILE_PATH = os.path.join(ROOT_DIR,CONFIG_DIR,CONFIG_FILE_NAME) #dynamically building file path, hence runs on any operating system

CURRENT_TIME_STAMP = f"{datetime.now().strftime('%Y-%m-%d-%H-%M-%S')}"


#Training pipeline related variables
TRAINING_PIPELINE_CONFIG_KEY= "training_pipeline_config" #the value to these variables are from config.yaml file
